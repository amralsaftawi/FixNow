...
public sealed class CompleteServiceRequestCommandHandler(
    ...
    : ICommandHandler<CompleteServiceRequestCommand, Result<Success>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        // 4. Apply the transition through the domain model (not allowed
        //    when already completed).
        var transitionResult = serviceRequest.Complete();
