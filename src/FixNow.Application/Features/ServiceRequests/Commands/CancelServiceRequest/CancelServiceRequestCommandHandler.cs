...
public sealed class CancelServiceRequestCommandHandler(
    ...
    : ICommandHandler<CancelServiceRequestCommand, Result<Success>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        // 4. Apply the cancellation through the domain model. The reason is
        //    derived from the authenticated identity (a customer cancelling
        //    their own request) - never supplied by the client.
        var cancelResult = serviceRequest.Cancel(
