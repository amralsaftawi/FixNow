...
public sealed class CancelJobCommandHandler(
    ...
    : ICommandHandler<CancelJobCommand, Result<Success>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        //    technician profile cannot cancel a job.
        ...
        // 3. Only the technician assigned to the job may cancel it. An
        ...
        //    owns the valid-transition rules (a completed job is terminal
        //    and can never be cancelled; an already-cancelled job is
        //    rejected by the existing idempotency convention); the client
        //    can never force an arbitrary status change.
        var transitionResult = job.ChangeStatus(JobStatus.Cancelled);
