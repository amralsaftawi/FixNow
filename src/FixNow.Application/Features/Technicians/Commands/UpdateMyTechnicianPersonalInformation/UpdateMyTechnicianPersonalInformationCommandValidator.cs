...
public sealed class UpdateMyTechnicianPersonalInformationCommandValidator
    : AbstractValidator<UpdateMyTechnicianPersonalInformationCommand>
{
    public UpdateMyTechnicianPersonalInformationCommandValidator()
    {
        ValidateFirstName();
