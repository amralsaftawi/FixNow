...
namespace FixNow.Application.Features.TechnicianProfiles.Commands.CreateTechnicianProfile;

public sealed class CreateTechnicianProfileCommandValidator
    : AbstractValidator<CreateTechnicianProfileCommand>
{
